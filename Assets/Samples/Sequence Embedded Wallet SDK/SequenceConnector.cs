...
namespace Game.Scripts
{
    ...
    public class SequenceConnector : MonoBehaviour
    {
        ...
        public const string ContractAddress = "0xca3216d13a2d891f267c52c0ed97cc854d561da6"; 
        ...
        private const string _mintEndpoint = "https://sequence-relayer.shadowbound.workers.dev";
        ...
        public TextMeshProUGUI tokenBalanceText; // UI Text for displaying balances
        public void MintFungibleToken(uint amount = 1, bool mintInInventory = true)
        {
            ...
            if (mintInInventory)
            {
                ...
                Inventory.RefreshTokenBalances(tokenBalanceText);
            }
        }
